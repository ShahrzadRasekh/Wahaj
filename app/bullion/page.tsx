...
export default function BullionCataloguePage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Simple top spacing to avoid header overlap if you add a global header later */}
      <main className="mx-auto max-w-6xl px-4 pb-16 pt-24">
        ...
        <nav className="mb-4 text-xs text-gray-500">
          ...
          <span className="text-gray-700">Wahaj Catalogue</span>
        </nav>
  ...
  {catalogueBrands.map((brand, index) => (
    ...
    >
      ...
      >
        ...
        <button className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-[#d12b2b] hover:text-[#b81f1f]">
        <Link
  href={`/bullion/${brand.slug}`}
